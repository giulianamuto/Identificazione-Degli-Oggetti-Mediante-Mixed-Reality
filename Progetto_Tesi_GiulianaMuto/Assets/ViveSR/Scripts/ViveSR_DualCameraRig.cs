...
namespace Vive.Plugin.SR
{
    ...
    public class ViveSR_DualCameraRig : ViveSR_Module
    {
       ...
       // Mi serve che io sia in modalità VR ma con le telecamere stereofrontali accese, quindi ho inserito 
       // un metodo che mi permettesse questo in VIRTUAL
        ...
        {
            //Sono a ture perchè attivano le camere stereo frontali
            DualCameraLeft.enabled = true;
            DualCameraRight.enabled = true;

            // Sono a folse perchè mi permettono di entrare nel mondo virtuale (altrimenti vedrei il mondo reale)
