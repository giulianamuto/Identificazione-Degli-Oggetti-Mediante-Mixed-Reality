...
namespace Vive.Plugin.SR
{
    ...
    public class SceneUnderstandingObjects
    {
        ...
        private InstanziatePrefabs instanziatePrefab = InstanziatePrefabs.FindObjectOfType<InstanziatePrefabs>();
        ...
        {
            // Parte in cui crea gli indici dei mesh cube
            ...
            {
                //Da gli attributi all'oggetto che crea
                ...
                //Ho eliminato i lcolore perchè non voglio vedere il deliniatore dell'oggetto
                mr.material.color = Color.clear;
              
                mf.mesh = new Mesh();


                //Parte in cui crea i vertici
                mf.mesh.MarkDynamic();
                ...
                //Questa è la parte dove viene passato a InitializationPrefabs le cordinate dell'oggetto
                //Ho deciso di inserire il box collider e prendere le posizioni perchè
                //la posizione effettiva del mesh cube è fittizzia
                //per trovarla dovevo calcolare una matrice ecc
                //ma computazionalmente non era granchè
                //facendo così ho risparmitato tempo a calcoli
                ...
                //Questo script lo trovi all'intenro del gameobject Instanziate
                //Viene passato: il nome dell'oggetto (sedia,tavolo, muro, pavimento e soffitto), 
                // la posizione, la scala, e il cube mesh
                instanziatePrefab.InitializationPrefabs(tagIdElement.tag, position, scale, Obj);
            }

        }


        //L'ho commentato perchè non mi importa di vedere le icone sugli oggetti
